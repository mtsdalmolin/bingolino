...
export const getTwitchAuthLink = () =>
  `https://id.twitch.tv/oauth2/authorize?client_id=${process.env.NEXT_PUBLIC_TWITCH_CLIENT_ID}&force_verify=true&redirect_uri=${process.env.NEXT_PUBLIC_TWITCH_REDIRECT_URL}&response_type=token&scope=user_read`;
